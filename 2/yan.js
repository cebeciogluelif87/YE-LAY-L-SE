...
function renderEpisode() {
  ...
  if (scene === 0) stage.innerHTML = `
    <div class="story-scene" style="grid-template-columns: 1fr;"><div class="scene-visual"><div class="canteen-window"></div><div class="old-locker"></div><div class="canteen-table"></div><div class="clue-glint"></div><div class="scene-caption"><span>OKUL KANTİNİ · ÖĞLE ARASI</span><h3>Bölüm 2 Başlangıç</h3></div></div></div>`;
